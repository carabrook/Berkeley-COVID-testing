...
make_Fig4_S2 <- function(filename){
load("Final-Figs/dat.test.all.10.20.lower.prop.UCB.Rdata")
head(dat.test.all)
...
load("Final-Figs/R0_test_all_group_10_20_lower_prop_UCB.Rdata")
...
make_Fig4_S2(filename="Final-Figs/Fig4-S2.png")
