...
make_FigS5 <- function(filename){
load("Final-Figs/dat.test.all.10.26.lower.prop.UCB.Rdata")
head(dat.test.all)
...
load("Final-Figs/R0_test_all_group_10_26_lower_prop_UCB.Rdata")
...
make_FigS5(filename="Final-Figs/FigS5.png")
