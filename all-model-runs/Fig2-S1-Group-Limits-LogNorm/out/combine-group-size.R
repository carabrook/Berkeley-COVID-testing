...
setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/Dec-2020/all-runs/FigS1-Group-Limits-LogNorm/out/")
...
#and save and plot.
save(dat, file = "dat.group.lim.lognorm.12.28.Rdata")
...
#and save and plot.
save(dat.test.R0, file = "R0.group.lim.lognorm.12.28.Rdata")
