...
setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/final-model-runs/Fig3-S2-Contact-Trace-Enhancement/out/")
...
load("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/final-model-runs/Fig3-Testing-TAT-LOD-Freq/out/dat.all.int.10.21.Rdata")
dat = subset(dat, LOD!="1e+03" & LOD!="1e+05" & LOD!="1e+07")
...
#and save 
save(dat.trace, file = "dat.trace.10.21.Rdata")
...
dat.test.R0 = subset(dat.test.R0, LOD!="1e+03" & LOD!="1e+05" & LOD!="1e+07")
head(dat.test.R0)
head(dat.trace.R0)
...
#and save and plot.
setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/final-model-runs/Fig3-S2-Contact-Trace-Enhancement/out/")
save(dat.trace.R0, file = "R0.trace.10.21.Rdata")
