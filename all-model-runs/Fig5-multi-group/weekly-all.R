...
multi.par$par1[multi.par$parameter=="test-rotation" & multi.par$FAST.enrolled=="yes"] <- "weekly"
...
multi.par$par1[multi.par$parameter=="test-freq"& multi.par$FAST.enrolled=="yes"] <- 7
...
out = replicate.epidemic(n.reps = 100,
                         ...
                         LOD=(10^1),
                         titer.dat = titer.dat,
                         test_rotation_name = "weekly-all")

save(out, file = "weekly-all.Rdata")
