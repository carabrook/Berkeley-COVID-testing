...
multi.par$par1[multi.par$parameter=="test-rotation" & multi.par$FAST.enrolled=="yes"] <- "biweekly"
...
multi.par$par1[multi.par$parameter=="test-freq"& multi.par$FAST.enrolled=="yes"] <- 3
...
out = replicate.epidemic(n.reps = 100,
                         ...
                         LOD=(10^1),
                         titer.dat = titer.dat,
                         test_rotation_name = "biweekly-all")

save(out, file = "biweekly-all.Rdata")
