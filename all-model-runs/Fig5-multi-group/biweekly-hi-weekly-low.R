...
multi.par$par1[multi.par$parameter=="test-rotation" & multi.par$FAST.enrolled=="yes" & multi.par$risk.group=="low"] <- "weekly"
...
multi.par$par1[multi.par$parameter=="test-freq"& multi.par$FAST.enrolled=="yes" & multi.par$risk.group=="low"] <- 7
...
out = replicate.epidemic(n.reps = 100,
                         ...
                         LOD=(10^1),
                         titer.dat = titer.dat,
                         test_rotation_name = "biweekly-high-weekly-low")

save(out, file = "biweekly-high-weekly-low.Rdata")
