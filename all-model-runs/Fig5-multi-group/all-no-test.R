...
multi.par$par1[multi.par$parameter=="TAT-lag"] <- Inf
multi.par$par2[multi.par$parameter=="TAT-lag"] <- Inf
multi.par$par1[multi.par$parameter=="test-rotation"] <- "none"
multi.par$par1[multi.par$parameter=="n-test-days-per-week"] <- NA
multi.par$par1[multi.par$parameter=="test-on"] <- FALSE
multi.par$par1[multi.par$parameter=="test-freq"] <- NA
...
out = replicate.epidemic(n.reps = 100,
                         ...
                         LOD=(10^1),
                         titer.dat = titer.dat,
                         test_rotation_name = "all-no-test")

save(out, file = "all-no-test.Rdata")
