...
#setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/final-model-runs/Fig4-Layered-Interventions/sub-1/")
...
out = replicate.epidemic(n.reps = 100,
                         ...
                         LOD=(10^1),
                         titer.dat = titer.dat,
                         test_rotation_name = "two-week-5-test-days")

save(out, file = "two-week-5-test-days-trace-symp-group.Rdata")
