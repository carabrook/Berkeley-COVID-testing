...
#setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/test-sensitivity/test-day-dist-all-1/")
...
save(out, file = "two-week-2-test-days-trace-1.Rdata")
