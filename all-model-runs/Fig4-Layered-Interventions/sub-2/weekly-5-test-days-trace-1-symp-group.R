...
#setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/test-sensitivity/test-day-dist/")
...
pop.par.base$par1[pop.par.base$parameter=="test-rotation"] <- "weekly"
pop.par.base$par1[pop.par.base$parameter=="n-test-days-per-week"] <- 5
pop.par.base$par1[pop.par.base$parameter=="test-on"] <- TRUE
pop.par.base$par1[pop.par.base$parameter=="test-freq"] <- 7
pop.par.base$par1[pop.par.base$parameter=="trace-lag"] <- 1
pop.par.base$par2[pop.par.base$parameter=="trace-lag"] <- .5
pop.par.base$par1[pop.par.base$parameter=="prop.trace"] <- .9
pop.par.base$par1[pop.par.base$parameter=="iso-lag"] <- 1
pop.par.base$par2[pop.par.base$parameter=="iso-lag"] <- .5
pop.par.base$par1[pop.par.base$parameter=="group-size-limit"] <- 12
...
out = replicate.epidemic(n.reps = 100,
                         ...
                         LOD=(10^1),
                         titer.dat = titer.dat,
                         test_rotation_name = "weekly-5-test-days")

save(out, file = "weekly-5-test-days-trace-1-symp-group.Rdata")
