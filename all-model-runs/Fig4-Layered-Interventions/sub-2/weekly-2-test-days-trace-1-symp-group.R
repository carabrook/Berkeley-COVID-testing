...
#setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/test-sensitivity/test-day-dist-all-2/")
...
out = replicate.epidemic(n.reps = 100,
                         ...
                         LOD=(10^1),
                         titer.dat = titer.dat,
                         test_rotation_name = "weekly-2-test-days")

save(out, file = "weekly-2-test-days-trace-1-symp-group.Rdata")
