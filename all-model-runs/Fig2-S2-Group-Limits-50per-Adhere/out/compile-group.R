...
homewd= "~/Documents/R/R_repositories/Berkeley-Reopening/Berkeley-COVID-testing"
setwd(paste0(homewd, "/all-model-runs/Fig2-S2-Group-Limits-50per-Adhere/out/"))
...
#and save 
save(dat, file = "dat.group.lim.10.21.Rdata")
...
#and save and plot.
save(dat.test.R0, file = "R0.group.lim.10.21.Rdata")
