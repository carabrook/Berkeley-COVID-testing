...
#setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/final-model-runs/Fig2-Group-Limits")
...
pop.par.base$par1[pop.par.base$parameter=="group-size-limit"] <- 50
...
save(out, file = "group-lim-50.Rdata")
