...
setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/final-model-runs/Fig2S1-Group-Limits-LogNorm/out/")
...
#and save and plot.
save(dat, file = "dat.group.lim.lognorm.10.19.Rdata")
...
#and save and plot.
save(dat.test.R0, file = "R0.group.lim.lognorm.10.19.Rdata")
