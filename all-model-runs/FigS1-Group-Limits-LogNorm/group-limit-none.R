...
#setwd("/Users/caraebrook/Documents/R/R_repositories/Berkeley-Reopening/final-model-runs/Fig2S1-Group-Limits-LogNorm")
...
load("virus.par.lognormal.10.2.Rdata")
...
R.fit.sum <- function(mat.df){
  ...
  #and nbinom fit
  #all.fit <-  apply(mat.df, 2, fitdist, densfun="log-normal")
...
pop.par.base$par1[pop.par.base$parameter=="group-size-limit"] <- Inf
...
save(out, file = "group-lim-none.Rdata")
