...
#setwd("~/Desktop/berkeley/Boots Lab/Covid testing/Berkeley-COVID-testing/model-sandbox/single-population")
...
ITERATION_NUMBER <- 5 #number of realizations of the model, recommend at least 10. 1 run takes ~30 seconds
...
TESTING <- FALSE #if false no testing is done
DAYS_BW_TESTS <- 3
